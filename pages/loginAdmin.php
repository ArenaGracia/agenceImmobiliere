    ...
    <div class="container">
        <form action="../traitement/verifierAdmin.php" method="post">
            <div class="login">
                ...
                <p class="input"><?php if(isset($_GET['retour'])) { echo "<label>Etes-vous vraiment un administrateur?<label>"; } ?></p>
                    <p class="input"><a href="login.php">Retour à la page de login Client</a></p>  
                </div>                
